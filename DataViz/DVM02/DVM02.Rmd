...
<tr style="height:50px">
<td>2<td>
<td> In this sheet, drag geometry from the MP14_SUBZONE table to the centre of the sheet to get the base Singapore Sub Zone map.</td>
<td><img align="left" src="img\from1.jpg" width="400px"></td>
</tr>

<tr style="height:50px">
  <td>3</td>
  <td> Frrom the Destination table, drag TOTAL_TRIPS to Color and DESTINATION_SZ to Detail under Marks</td>
